...
/*now we want to join the benchmarkGPUData (https://www.videocardbenchmark.net/GPU_mega_page.html) table where the video card name matches the description in the neweggGPUDataUpdateURL table */
...
/* We notice from the query above we got a gpu_name 'ION' from the benchmark table, this is not GPU is not in our neweggGPUDataUpdatedURL table
